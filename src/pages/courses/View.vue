...
<template>
  <div v-if="user.can('courses.view')">
          ...
          <div class="p-5">
            <form class="validate-form" @submit.prevent="onSubmit" v-if="course.id">
              <div class="input-form">
                ...
                <TomSelect v-model="course.type" :options="{ placeholder: 'Kurs türü seçin.' }" class="w-full" disabled>
              ...
              <div class="input-form mt-4">
                ...
                <FormInput id="name" v-model="course.name" :value="course.name" type="text" name="name" disabled
              ...
              <div class="input-form mt-4">
                ...
                <div class="relative w-90">
                  ...
                  <Litepicker disabled v-model="course.start_at" :value="course.start_at" :options="{
                    autoApply: false,
              ...
              <div class="input-form mt-4">
                ...
                <div class="relative w-90">
                  ...
                  <Litepicker disabled v-model="course.can_be_applied_until" :value="course.can_be_applied_until" :options="{
                    autoApply: false,
                    showWeekNumbers: true,
                    format: 'DD-MM-YYYY HH:mm',
                    startDate: course.can_be_applied_until,
                    dropdowns: {
                      minYear: 2021,
                      maxYear: 2027,
                      months: true,
              ...
              <div class="mt-4">
                ...
                <div class="mt-2">
                  <FormSwitch>
                    <FormSwitch.Input id="is_active" type="checkbox" name="is_active" v-model="course.is_active" disabled />
              ...
              <div class="mt-4">
                ...
                <div class="mt-2">
                  <FormSwitch>
                    <FormSwitch.Input id="can_be_applied" type="checkbox" name="can_be_applied" disabled
