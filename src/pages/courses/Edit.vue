            ...
            <form class="validate-form" @submit.prevent="onSubmit" v-if="course.id">
              ...
              <div class="input-form mt-4">
                ...
                <div class="relative w-90">
                  ...
                  <Litepicker v-model="course.start_at" :value="course.start_at" :options="{
                    autoApply: false,
              ...
              <div class="input-form mt-4">
                ...
                <div class="relative w-90">
                  ...
                  <Litepicker v-model="course.can_be_applied_until" :value="course.can_be_applied_until" :options="{
                    autoApply: false,
                    showWeekNumbers: true,
                    format: 'DD-MM-YYYY HH:mm',
